...
/-
Definition of the existence of a strategy for the puzzle. A strategy exists if there is a function f such that for any code z and any target k,
there is a bit i such that flipping the i-th bit of z results in a code that f maps to k.
-/
